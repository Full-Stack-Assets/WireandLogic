    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="prose-editorial">
        ...
        <ol>
          ...
          <li><strong>Publish.</strong> The MDX file, with a Pexels banner and frontmatter, is committed to GitHub. The hosting platform rebuilds from the committed content.</li>
        </ol>
        ...
        <h2>The stack</h2>
        <p>
          Next.js, TinaCMS, Groq&rsquo;s free tier, and a lot of free public APIs.
