...
export interface TopicPipelineOptions {
  /** If true, don't commit to GitHub — return the MDX content instead. */
  dryRun?: boolean;
  /** Frontmatter date for the post (defaults to now). The seed/backfill runner
   *  spreads these across recent history to build a believable back catalog. */
  date?: Date;
 ...
 * trending sources. It skips stages 1–2 (gather/score), synthesizes a "winner"
